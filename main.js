function setActive(type) {
  ...
  switch (type) {
    case "marketing":
      ...
      let myMarketingCards = document.querySelectorAll(
        ".card-holder.marketing"
      );
    ...
    case "development":
      ...
      let myDevelopmentCards = document.querySelectorAll(
        ".card-holder.developer"
      );
